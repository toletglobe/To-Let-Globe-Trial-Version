        ...
        <div className={`pb-4 ${selectComp > 2 ? "hidden" : ""}`}>
          <div className={`bg-white w-full rounded-lg p-3`}>
            ...
            <p className=" text-left mb-0">
              Brand New!! Commercial 2 BHK fully Furnished house at 3rd floor
              with both indian and western bathroom, great for familiy or extra
              income. Price is negotiable located at Gomti Nagar, Lucknow.
            </p>
          </div>
        </div>
