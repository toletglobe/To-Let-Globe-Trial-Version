...
import img1 from "../../../assets/image/property/property-2.jpg"
...
import profile from "../../../assets/image/property/author2.jpg"
    ...
    <div className="pl-2 pr-4 mx-4">
      ...
      <div className="md:flex justify-between	pt-8">
        ...
        <div className="border-1	bg-white rounded-l w-1/4 p-4">
          ...
          <div>
            <p className="block text-gray-400">+91 9559015618</p>
          </div>
