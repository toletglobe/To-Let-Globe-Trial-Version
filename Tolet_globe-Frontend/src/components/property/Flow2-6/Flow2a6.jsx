...
import img1 from "../../../assets/image/property/property-6.jpg"
...
import profile from "../../../assets/image/property/author6.jpg"
    ...
    <div className="pl-2 pr-4 mx-4">
      ...
      <div className="md:flex justify-between	pt-8">
        <div className="">
          ...
          <p className="text-gray-400 block">Sarojini Nagar Kanpur highway and Bijnor road  ,Lucknow</p>
        ...
        <div className="border-1	bg-white rounded-l w-1/4 p-4">
          ...
          <div className="flex">
            ...
            <p className="pt-1 pl-3 text-gray-800">Anurag</p>
          </div>
          <div>
            <p className="block text-gray-400">+91 7311132847</p>
          </div>
