        ...
        <div className={`pb-4 ${selectComp > 2 ? "hidden" : ""}`}>
          <div className={`bg-white w-full rounded-lg p-3`}>
            ...
            <p className=" text-left mb-0">
              Brand New!! Residential 2 BHK Semi Furnished House at 2nd floor
              with Western bathrooms and Car Parking facility great for nuclear
              family or extra income. Pets are allowed and price is not negotiable
              located at Panchmukhi Mandir, Alambagh.
            </p>
          </div>
        </div>
