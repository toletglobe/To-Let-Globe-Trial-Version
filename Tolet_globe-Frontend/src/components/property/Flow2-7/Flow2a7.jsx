...
import img1 from "../../../assets/image/property/property-7.jpg"
...
import profile from "../../../assets/image/property/author7.jpg"
    ...
    <div className="pl-2 pr-4 mx-4">
      ...
      <div className="md:flex justify-between	pt-8">
        <div className="">
          ...
          <p className="text-gray-400 block">Panchmukhi Mandir, Alambagh</p>
        ...
        <div className="border-1	bg-white rounded-l w-1/4 p-4">
          ...
          <div className="flex">
            ...
            <p className="pt-1 pl-3 text-gray-800">Sanjeev</p>
          </div>
          <div>
            <p className="block text-gray-400">+91 9569515895</p>
          </div>
