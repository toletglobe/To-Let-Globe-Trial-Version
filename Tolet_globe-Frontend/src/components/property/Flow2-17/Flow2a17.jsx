    ...
    <div className="pl-2 pr-4 mx-4">
      ...
      <div className="md:flex justify-between	pt-8">
        <div className="">
          ...
          <p className="text-gray-400 block">15/2 Immant nagar</p>
          ...
          <div className="flex">
            ...
            <MdStarOutline className="text-[#FFFEFE] mt-1" />
            <MdStarOutline className="text-[#FFFEFE] mt-1" />
            <p className="ml-2 text-gray-400">28 (Reviews)</p>
          </div>
        ...
        <div className="border-1	bg-white rounded-l w-1/4 p-4">
          ...
          <div className="flex">
            ...
            <p className="pt-1 pl-3 text-gray-800">Devanshi</p>
          </div>
          <div>
