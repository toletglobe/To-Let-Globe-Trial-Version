        ...
        >
          ...
          <div className="flex flex-wrap max-w-full">
            <div className="border flex p-2 rounded-lg border-black mr-8">
              ...
              <p className="inline pb-0 mb-0 font-normal">1 Bedrooms</p>
            </div>
        ...
        <div className={`pb-4 ${selectComp > 2 ? "hidden" : ""}`}>
          <div className={`bg-white w-full rounded-lg p-3`}>
            ...
            <p className=" text-left mb-0">
              Brand New!! Commercial 1 BHK Fully Furnished shop at ground floor
              with both indian and western washroon, great for business men or
              extra income. Price is negotiable located at 15/2 Immant nagar
              Lucknow.
            </p>
          </div>
        </div>
