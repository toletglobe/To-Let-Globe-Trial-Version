...
import img1 from "../../../assets/image/property/property-3.jpg"
...
import profile from "../../../assets/image/property/author3.jpg"
    ...
    <div className="pl-2 pr-4 mx-4">
      ...
      <div className="md:flex justify-between	pt-8">
        <div className="">
          ...
          <div className="border-1 rounded-lg border-gray-600 flex justify-between pl-3 pr-3">
            <div className="p-1">
              ...
              <h3 className="pr-1">Rs. 14,000/Month</h3>
            </div>
        ...
        <div className="border-1	bg-white rounded-l w-1/4 p-4">
          ...
          <div>
            <p className="block text-gray-400">+91 9560605544</p>
          </div>
